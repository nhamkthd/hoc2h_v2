<div class="container" style="margin-top: 50px">
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="view_test" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="attend_test" value="0" type="hidden" class="form-control">
	...
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="comment_test" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="rate_test" value="0" type="hidden" class="form-control">
	...
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="edit_test_by_self" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="edit_test_by_everyone" value="0" type="hidden" class="form-control">
	...
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="delete_test_by_self" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="delete_test_by_everyone" value="0" type="hidden" class="form-control">
	...
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="approve_test_create" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="stick_test" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="create_test" value="0" type="hidden" class="form-control">
		...
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="view_test_explan" value="0" type="hidden" class="form-control">
	...
	<div class="row show-grid">
		<div class="col-md-6">
			...
			<div class="col-md-6">
				<input name="check_user_test" value="0" type="hidden" class="form-control">
