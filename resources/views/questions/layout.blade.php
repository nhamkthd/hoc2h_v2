    ...
    <div class="container" ng-app="hoc2h-question" ng-controller="QuestionController">
        <div class="row">
            <div class="col-md-3 sidebar">
                ...
                <section>
                    <ul class="menu-list">
                        <li ng-class="{active:tab === 1}"><a href > Mới nhất </a></li>
                        <li ng-class="{active:tab === 2}"><a href > Nổi bật</a></li>
                        ...
                        <li ng-class="{active:tab === 6}"><a href > Đã được giải quyết </a></li>
                        <li ng-class="{active:tab === 7}"><a href > Chưa được giải quyết </a></li>
                        <li ng-class="{active:tab === 8}"><a href > Chưa có câu trả lời </a></li>
                        <li ng-class="{active:tab === 9}"><a href> Thành viên tiêu biểu </a></li>
                    </ul>
                </section>
            </div>
