...
@verbatim
    <div class="" ng-show="show">
        <div class="col-xs-5 col-md-3 pull-right chat-window" ng-repeat="msg in list_msg">
            <div class="panel panel-primary">
                <div class="panel-heading top-bar">
                    <div class="col-md-8 col-xs-8 ">
                        <h3 class="panel-title"><i class="fa fa-circle user-status online" aria-hidden="true"></i> Chat </h3>
                    </div>
